                ...
                >
                    <View>
                        {swap.user1_id === session.user.id ? (
                            <Text>
                                <span style={{ fontWeight: 'bold' }}>{swap.user2_username}</span>
                                <Text> </Text>
                                would like to create a swap for
                                <Text> </Text>
                                <Text style={{ fontWeight: 'bold' }}>{swap.user1_book_title}</Text>
                            ...
                            <Text>
                                ...
                                <Text style={{ fontWeight: 'bold' }}>{` ${swap.user2_book_title} `}</Text>
                                <Text>for</Text>
