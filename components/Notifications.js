                                    ...
                                    >
                                        <View key={notification.swapData.offer_date}>
                                            ...
                                            <div style={styles.flex}>
                                                ...
                                                />
                                                <Text>
                                                    <span style={{ fontWeight: 'bold' }}>{notification.swapData.user2_username}</span>
                                                    <Text> </Text>
                                                    would like to create a swap for
                                                    <Text> </Text>
                                                    <Text style={{ fontWeight: 'bold' }}>{notification.swapData.user1_book_title}</Text>
                                                </Text>
                                            </div>
                                            <Pressable
                                ...
                                return (
                                    ...
                                    >
                                        <View>
                                            <Text>{daysSince(notification.created_at)} days ago</Text>
                                            <div style={styles.flex}>
                                                <Text style={{ fontWeight: 'bold' }}>{notification.username} </Text>
                                                <Image
